...
<div class="page">
    <div class="page-header">
        <h1 class="page-title"><?php echo $page; ?> List</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Home</a></li>
            <li class="breadcrumb-item active"><?php echo $page; ?> List</li>
        </ol>
    </div>
    <div class="page-content container-fluid">
        <div class="panel-body">
            <a href="<?php echo base_url('admin/manage_degree/'.$type); ?>" id="add_university" class="btn btn-success btnadd">Add New</a>
            <a href="javascript:void(0)" id="export_universities" class="btn btn-success btnright">Export <?php echo $page; ?> list</a>
            <table id="university_list" class="table table-hover dataTable table-striped w-full table-bordered table-responsive">
                ...
                foreach ($degree_list as $round) { ?>
                    <tr>
                        <td><?php echo $round->degree_name; ?></td>
                        <td><?php echo $round->user_name." (".date("jS F Y, g:i a", strtotime($round->last_updated)). ")  "; ?></td>
                        <td><a href="<?php echo base_url('admin/manage_degree/'.$type.'/'.$round->degree_id);?>" class="btn btn-icon btn-primary" role="button"><i class="icon wb-pencil" aria-hidden="true"></i></a>
                        <button type="button" data-id="<?php echo $round->degree_id; ?>" data-pk="degree_id" data-type="ref_degree" class="btn btn-icon btn-danger delete"><i class="icon wb-trash" aria-hidden="true"></i></button>
                        </td>
                    </tr>
                <?php } }?>
                </tbody>

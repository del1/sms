                    ...
                    <div id="accordion">
                        ...
                        <div>
                            <div class="col-sm-12 col-md-12 mt-20">
                                ...
                                <div class="form-group row mt-20">
                                    ...
                                    <label for="type_of_lead" class="form-control-label col-md-2 col-sm-2 col-xl-1 col-lg-2" style="text-align: left;">Type of lead</label>
                                    <div class="col-md-4 col-lg-4 col-sm-4 col-xl-5">
                                        <select id="type_of_lead" class="form-control" name="lead_type_id">
                                            <option hidden>Select Lead Types</option>
                                            <?php foreach ($lead_types as $key => $value) { ?>
                                            <option <?php if(isset($enquiery_data->lead_type_id) && $enquiery_data->lead_type_id==$value->lead_type_id) { echo 'selected'; } ?> value="<?php echo $value->lead_type_id; ?>"><?php echo $value->lead_type; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div>
                            ...
                            <div class="col-sm-12 col-md-12 mt-20">
                                ...
                                <?php if($enquiery_data->is_converted =="true"){ ?>
                                <hr>
                ...
                <?php $arr=array('class'=>"form-horizontal mt-30","id"=>"second_section");
                    ...
                    <?php if(isset($applied_student_colleges) && !empty($applied_student_colleges)){ 
                        ...
                        <section class="removeCollegeParent <?php if(end($applied_student_colleges)==$app_college) { echo 'last_college_application'; } ?>">
                            ...
                            <div class="form-group row" >
                                <label class="form-control-label col-md-2 col-sm-2 col-xl-1 col-lg-2" style="text-align: left;">Taken our assistance</label>
                                <div class="col-md-2 col-lg-3 col-sm-4  col-xl-3">
                                    <select name="taken_our_assistance[]" class="form-control taken_our_assistance">
                                        <option hidden="" value="0">Yes/No</option>
                                        <option <?php if($app_college->taken_our_assistance=="true"){ echo "Selected"; } ?> value="1">Yes</option>
                                        <option <?php if($app_college->taken_our_assistance=="false"){ echo "Selected"; } ?> value="2">No</option>
                                    </select>
                                    <span class="error"></span>
                                </div>
                            </div>
                            <div class="form-group row" >
                                ...
                                <div class="col-md-2 col-lg-3 col-sm-4  col-xl-3">
                                    <select name="admit_status_id[]" class="form-control admit_status_id">
                                        <option  hidden="" value="0">Select Admit status</option>
    ...
    jQuery(document).ready(function($) {
        ...
        $(document).on('change', '.admit_status_id', function(event) {
                ...
                if(this.value=="1"){
                    ...
                    targetClass1.next().empty();
                    targetClass.attr('disabled','true');
                    targetClass.next().empty();
                }
        });
        ...
        $(document).on('click', '.btnSec2Submit', function(event) {
            event.preventDefault();
            var section2err=0;
            var find_array=["college_id","intake_year","round_id","app_status_id","intv_status_id","applied_program_id","taken_our_assistance","admit_status_id"];
            var error_array=["Please select College","Please add intake year","Please Select Application round","Please Select Application Status","Please Select Interview Status","Please Select Applied Program","Please select appropriate choice","Please select Admit Status"];

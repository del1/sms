...
<div class="page">
    <div class="page-header">
        <h1 class="page-title">Source List</h1>
        <ol class="breadcrumb">
    ...
    <div class="page-content container-fluid">
        <div class="panel-body">
            <a href="<?php echo base_url('admin/manage_source'); ?>" id="add_university" class="btn btn-success btnadd">Add Source</a>
            <a href="javascript:void(0)" id="export_universities" class="btn btn-success btnright">Export Sources</a>
            <table id="university_list" class="table table-hover dataTable table-striped w-full table-bordered table-responsive">
                ...
                <tbody>
                <?php foreach ($source_list as $round) { ?>
                    <tr>
                        <td><?php echo $round->source_name; ?></td>
                        <td><?php echo $round->user_name." (".date("jS F Y, g:i a", strtotime($round->last_updated)). ")  "; ?></td>
                        <td><a href="<?php echo base_url('admin/manage_source/'.$round->source_id);?>" class="btn btn-icon btn-primary" role="button"><i class="icon wb-pencil" aria-hidden="true"></i></a>
                        <button type="button" data-id="<?php echo $round->source_id; ?>" data-pk="source_id" data-type="ref_source" class="btn btn-icon btn-danger delete"><i class="icon wb-trash" aria-hidden="true"></i></button>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>

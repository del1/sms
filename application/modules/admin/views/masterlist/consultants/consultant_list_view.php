...
<div class="page">
    <div class="page-header">
        <h1 class="page-title">Consultant List</h1>
        <ol class="breadcrumb">
    ...
    <div class="page-content container-fluid">
        <div class="panel-body">
            ...
            <a href="javascript:void(0)" id="export_universities" class="btn btn-success btnright">Export Consultant list</a>
            <table id="university_list" class="table table-hover dataTable table-striped w-full table-bordered table-responsive">
                ...
                <?php foreach ($consultant_list as $round) { ?>
                    <tr>
                        ...
                        <button type="button" data-id="<?php echo $round->user_id; ?>" data-pk="user_id" data-type="ref_approunds" class="btn btn-icon btn-danger delete"><i class="icon wb-trash" aria-hidden="true"></i></button>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>
